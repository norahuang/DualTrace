...
public class Force64BitRegistersHandler extends AbstractHandler {
	@Override
	...
	static public boolean isToggledToShow(){
	    ...
	    Command command = commandService.getCommand("ca.uvic.chisel.atlantis.commands.Force64BitRegisters");
