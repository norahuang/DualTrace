 ...
 */
public class BinaryFormatFileTextSearchVisitor {
	...
	private final BinaryFormatTextSearchResultCollector fCollector;
	...
	public BinaryFormatFileTextSearchVisitor(TextSearchRequestor collector, Pattern searchPattern, boolean useRegexSearch) {
		...
		fCollector= (BinaryFormatTextSearchResultCollector) collector;
