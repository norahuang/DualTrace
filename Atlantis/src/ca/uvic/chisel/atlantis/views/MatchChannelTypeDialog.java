...
public class MatchChannelTypeDialog extends ChannelTypeDialog{

	public MatchChannelTypeDialog(Shell parentShell) {
		super(parentShell);
	...
	protected void okPressed() {
		...
		findMatchChannels(new ArrayList<String>(selectedChannels.values()));
		super.okPressed();
	}

	private void findMatchChannels(List<String> selectedChannels) {
		...
		if (editorPart1.getObject() instanceof CompatibilityEditor
			...
			if (dualTraceChannelView != null) {
				dualTraceChannelView.getMatchChannels(selectedChannels, editor1, editor2);
			}
