 ...
 * @since 3.0
 */
public final class NewLineNumberChangeRulerColumn extends BfvLineNumberRulerColumn implements IChangeRulerColumn, IRevisionRulerColumn, IRevisionRulerColumnExtension {
	 ...
	 * @since 3.2
	 */
	private final BfvDiffPainter fDiffPainter;
	/**
	 ...
	 */
	public NewLineNumberChangeRulerColumn(ISharedTextColors sharedColors) {
		Assert.isNotNull(sharedColors);
		fRevisionPainter= new RevisionPainter(this, sharedColors);
		fDiffPainter= new BfvDiffPainter(this, sharedColors);
	}
	...
	public void setCurrentCollapsedRegions(List<ILineRange> collapsedRanges) {
		super.setCurrentCollapsedRegions(collapsedRanges);
		
		fDiffPainter.setCurrentCollapsedRegions(collapsedRanges);
	}
