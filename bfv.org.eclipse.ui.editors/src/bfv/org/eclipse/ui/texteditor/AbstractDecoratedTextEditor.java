 ...
 *******************************************************************************/
package bfv.org.eclipse.ui.texteditor;
...
import bfv.org.eclipse.ui.editors.text.DefaultEncodingSupport;
import bfv.org.eclipse.ui.editors.text.EditorsUI;
import bfv.org.eclipse.ui.editors.text.ForwardingDocumentProvider;
import bfv.org.eclipse.ui.editors.text.IEncodingSupport;
import bfv.org.eclipse.ui.editors.text.IStorageDocumentProvider;
import bfv.org.eclipse.ui.editors.text.ITextEditorHelpContextIds;
import bfv.org.eclipse.ui.internal.editors.quickdiff.CompositeRevertAction;
import bfv.org.eclipse.ui.internal.editors.quickdiff.RestoreAction;
import bfv.org.eclipse.ui.internal.editors.quickdiff.RevertBlockAction;
import bfv.org.eclipse.ui.internal.editors.quickdiff.RevertLineAction;
import bfv.org.eclipse.ui.internal.editors.quickdiff.RevertSelectionAction;
import bfv.org.eclipse.ui.internal.editors.text.EditorsPlugin;
import bfv.org.eclipse.ui.internal.editors.text.NLSUtility;
import bfv.org.eclipse.ui.internal.editors.text.RefreshEditorAction;
import bfv.org.eclipse.ui.internal.texteditor.AnnotationColumn;
import bfv.org.eclipse.ui.internal.texteditor.BooleanPreferenceToggleAction;
import bfv.org.eclipse.ui.internal.texteditor.LineNumberColumn;
import bfv.org.eclipse.ui.internal.texteditor.TextChangeHover;
import bfv.org.eclipse.ui.texteditor.AbstractDecoratedTextEditorPreferenceConstants;
import bfv.org.eclipse.ui.texteditor.AbstractMarkerAnnotationModel;
import bfv.org.eclipse.ui.texteditor.AddMarkerAction;
import bfv.org.eclipse.ui.texteditor.AddTaskAction;
import bfv.org.eclipse.ui.texteditor.AnnotationPreferenceLookup;
import bfv.org.eclipse.ui.texteditor.ChangeEncodingAction;
import bfv.org.eclipse.ui.texteditor.DefaultMarkerAnnotationAccess;
import bfv.org.eclipse.ui.texteditor.DocumentProviderRegistry;
import bfv.org.eclipse.ui.texteditor.MarkerAnnotation;
import bfv.org.eclipse.ui.texteditor.MarkerAnnotationPreferences;
import bfv.org.eclipse.ui.texteditor.MarkerUtilities;
...
public abstract class AbstractDecoratedTextEditor extends StatusTextEditor {
	 ...
	 */
	protected IVerticalRulerColumn fLineNumberRulerColumn;
	/**
	 ...
	 */
	protected void initializeLineNumberRulerColumn(BfvLineNumberRulerColumn rulerColumn) {
		/*
	...
	protected IVerticalRulerColumn createLineNumberRulerColumn() {
		 ...
		 * Left for compatibility. See LineNumberColumn.
		 */
		fLineNumberRulerColumn= new NewLineNumberChangeRulerColumn(getSharedColors());
		((IChangeRulerColumn) fLineNumberRulerColumn).setHover(createChangeHover());
		initializeLineNumberRulerColumn((BfvLineNumberRulerColumn)fLineNumberRulerColumn);
	...
	protected void updateLineNumberColumnForPropertyChange(
			PropertyChangeEvent event) {
		String property2 = event.getProperty();
		if (LINE_NUMBER_RULER.equals(property2)) {
			// only handle visibility of the combined column, but not the number/change only state
			IColumnSupport columnSupport= (IColumnSupport)getAdapter(IColumnSupport.class);
