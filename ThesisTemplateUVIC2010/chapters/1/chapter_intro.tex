...
\begin{itemize}
  ...
  \item \textbf{Communication Identification Approach:} The overall approach to identify the communication of a communication method is designed. Some algorithms are developed for the steps in this approach regarding to some communication methods or communication categories.
  \item \textbf{Feature Prototype:} A feature prototype is designed and implemented on Atlantis to test and prove the communication identification approach.
\end{itemize}
