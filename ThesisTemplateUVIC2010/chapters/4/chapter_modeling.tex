...
\caption{Send/Receive Scenarios of Named Pipe}\label{scenarios}\\
\hline
\textbf{Scenario} & \textbf{Diagram} & \textbf{Comment}\\ \hline
 1 &\raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario1}} & Message send/receive successfully in order                       \\ \hline
 2 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario2}}  & Message send/receive successfully but out of order \\ \hline
 3 &\raisebox{-\totalheight}{  \includegraphics[scale=0.3]{Figures/scenario3}} &  Message send/receive fail \\ \hline
 4 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario4}} & One sent message received segmented \\ \hline
 5 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario5}}  & One sent message received segmented and out of order \\ \hline
 6 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario6}}  &  One sent message received segmented in order, but partially lost \\ \hline
 7 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario7}}  & One sent message received segmented out of order and partially lost \\ \hline
 8 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario8}}  & Multiple messages received at a time \\ \hline
 9 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario9}}  & Multiple messages received at a time, but partially lost \\\hline
 10 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario10}} &  Messages segmented and reconstructed in order \\ \hline
 11 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario11}} &  Messages segmented and reconstructed out of order \\ \hline
 12 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario12}} & Messages segmented and reconstructed partially lost \\ \hline
 13 & \raisebox{-\totalheight}{ \includegraphics[scale=0.3]{Figures/scenario13}} & Messages segmented and reconstructed out of order and partially lost \\ \hline
\end{longtable}
