...
\begin{lstlisting}[caption= communicationMethods.json]
[
   {
...
\section{Code for Parallel Editors}\label{paralleleditor}
...
\lstinputlisting[language=C++,caption= NamedPipeClient.cpp]{./sourcecode/experiment2/NamedPipeClient.cpp}
