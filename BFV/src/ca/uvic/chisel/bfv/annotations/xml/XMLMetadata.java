 ...
 */
@XmlRootElement
@XmlType(propOrder={"parentFolder", "associatedFile"})
public abstract class XMLMetadata {
	...
	/**
	 * Gets the name of the file that this XML metadata is associated with.
	 * @return file name
	 */
	...
	/**
	 * Sets the name of the file that this XML metadata is associated with.
	 * @param associatedFile file name
	 */
