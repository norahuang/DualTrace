 ...
 *******************************************************************************/
package ca.uvic.chisel.bfv.projectionsupport;
 ...
 * @since 2.1
 */
public class ProjectionAnnotationsPainter implements IPainter, PaintListener, IAnnotationModelListener, IAnnotationModelListenerExtension, ITextPresentationListener {
	 ...
	 *
	 * @since 3.0
	 * @deprecated As of 3.4, replaced by {@link ProjectionAnnotationsPainter.UnderlineStrategy}
	 */
	 ...
	 *             {@link #addTextStyleStrategy(Object, ProjectionAnnotationsPainter.ITextStyleStrategy)} and
			...
			for (int i= startLine; i <= endLine; i++) {
				...
				if (paintLength >= 0 && regionsTouchOrOverlap(paintStart, paintLength, clippingOffset, clippingLength)) {
					...
					if (widgetRange != null) {
						...
						// XXX This assumes that we do not have ANYTHING visible in a collapsed region
						break;
					}
				}
				
				// we should only ever want to draw this stuff on one line
				break;
			}
