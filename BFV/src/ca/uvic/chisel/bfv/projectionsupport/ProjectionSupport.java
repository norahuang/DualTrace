...
public class ProjectionSupport {
	...
	private static class ProjectionDrawingStrategy implements ProjectionAnnotationsPainter.IDrawingStrategy {
		/*
	 ...
	 * @since 3.1
	 */
	private ProjectionAnnotationsPainter.IDrawingStrategy fDrawingStrategy;
	 ...
	 * @since 3.1
	 */
	public void setAnnotationPainterDrawingStrategy(IDrawingStrategy strategy) {
